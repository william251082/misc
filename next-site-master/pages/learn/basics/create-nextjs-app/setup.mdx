...
> Under the hood, this uses the tool called `create-next-app`, which bootstraps a Next.js app for you. It uses [this template](https://github.com/vercel/next-learn-starter/tree/master/learn-starter) through the `--example` flag.
>
> If it doesn’t work, please take a look at [this page](https://github.com/vercel/next-learn-starter/blob/master/errors/install.md).
