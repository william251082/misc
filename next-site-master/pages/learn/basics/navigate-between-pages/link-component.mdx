...
In Next.js, you use the `Link` Component from [`next/link`](/docs/api-reference/next/link) to wrap the `<a>` tag. `<Link>` allows you to do client-side navigation to a different page in the application.
